...
table.add_row("[code]Sistema[code]", style="bold red")
...
table.add_row("")
table.add_row("[code]Utilidades[code]", style="bold red")
...
table.add_row("")
table.add_row("[code]Osint[code]", style="bold red")
...
table.add_row("")
table.add_row("[code]Osint/Discord[code]", style="bold red")
...
table.add_row("")
table.add_row("[code]Pentesting[code]", style="bold red")

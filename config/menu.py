...
class StellarOS:
    def __init__(self):
        ...
        self.themes = {
            ...
            "frost":   {"primary":"black","secondary":"blue","highlight":"magenta","bg":"#e0f7fa"},
            "sunset":  {"primary":"black","secondary":"dark_red","highlight":"dark_blue","bg":"#fff3e0"},
            "pastel":  {"primary":"black","secondary":"pink1","highlight":"cyan","bg":"#f5e6e8"},
            "clean":   {"primary":"black","secondary":"grey50","highlight":"dark_blue","bg":"#ffffff"},
            "midnight":{"primary":"white","secondary":"cyan","highlight":"bright_magenta","bg":"#001f3f"},
    ...
    def create_table(self):
        ...
        # MAIN: introducción + lista de categorías
        if cat == "MAIN":
            intro = self.menu_data["MAIN"][0][1]
            cats = " • ".join([c for c in self.categories if c != "MAIN"] )
            content = intro + f"\n\nCategorías: {cats}"
            return Panel(
                Align.left(content),

...
class StellarOS:
    ...
    def animated_banner(self):
        ...
        text = Text()
        text.append(" STELLAR OS ", style=f"bold {theme['secondary']} blink")
    ...
    def create_table(self):
        ...
        if cat == 'MAIN':
            ...
            layout = Layout()
            layout.split_column(Layout(intro_panel), Layout(cat_panel))
            return layout
    ...
    def tips_panel(self):
        ...
        tips.append(" w/s   Subir/Bajar Categorías\n", style="dim")
        tips.append(" t     Cambiar tema\n", style="dim")
        tips.append(" q     Salir", style="dim")
        return Panel(
            tips,
            box=ROUNDED,

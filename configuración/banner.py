...
console.print(f"[bold green]OS: [/bold green][bold white]{os_version}[/bold white]")
console.print(f"[bold green]Sistema: [/bold green][bold white]{system_info}[/bold white]")

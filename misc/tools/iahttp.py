...
def main():
    console.print(Panel("[bold green]Chat LlaMa IA[/bold blue]\n[bold white]Tu asistente virtual de inteligencia artificial[/bold white]", title="Bienvenido", title_align="center"))
